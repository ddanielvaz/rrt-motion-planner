...
TrackingControlPioneer3AT::TrackingControlPioneer3AT(SkidSteerControlBased *robot)
{
    p3at = robot;
}
...
*/
void TrackingControlPioneer3AT::run(const double *curr_st, const double *ref_st, const double *ctl, double *tracked_st)
{
