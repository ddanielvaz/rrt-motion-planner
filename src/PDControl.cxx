...
//     cout << "ref_state.v: " << ref_state.v << " ref_state.w: " << ref_state.w << endl;
    ...
    ComputeErrorState(curr_state, ref_state, &vc);
//     cout << "v_error: " << vc.v << " w_error: " << vc.w << endl;
    ComputeDerivativeErrorState(curr_state, ref_state, &dvc);
//     cout << "dv_error: " << dvc.v << " dw_error: " << dvc.w << endl;
    ComputeControlInput(vc, dvc, control_inputs);
...
void PDControl::ComputeControlInput(VelocityState pvc, VelocityState dvc,
                                    double *u)
{
    u[0] = kp_v * pvc.v + kd_v * dvc.v;
    u[1] = kp_w * pvc.w + kd_w * dvc.w;
}
