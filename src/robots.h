                                             ...
                                             const double *ctl, double *dx)
{
    ...
    cout << "curr_vel_linear: " << curr_vel[0] << endl;
    cout << "curr_vel_angular: " << curr_vel[1] << endl;
                                             ...
                                             double *dx)
{
    ...
    vx = x[VX_SPEED];
    w = dtheta = x[ANGULAR_SPEED];
    cout << "FLOW curr_vel_linear: " << vx << endl;
    cout << "FLOW curr_vel_angular: " << w << endl;
    vx1 = vx - c * w;
    vx2 = vx + c * w;
    vy1 = (-xcir + b) * w;
    vy3 = (-xcir - a) * w;
