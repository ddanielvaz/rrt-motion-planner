...
void Tracking::control(char *log, char *ip)
{
    ...
    double vx_e, va_e, angle_e, x_e, y_e;
    ...
    while(path_fp.getline(temp, 100))
    {
        ...
        x_e = (path_log_pos.px - curr_pos.px);
        y_e = (path_log_pos.py - curr_pos.py);
        angle_e = normalize_angle(path_log_pos.pa - curr_pos.pa);
